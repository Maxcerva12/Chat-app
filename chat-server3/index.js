...
app.use(
  cors({
    origin: ["http://localhost:3000", "http://10.26.41.81:3000"],
    methods: ["GET", "POST"],
  })
);
...
// io.adapter(redisAdapter({ host: "192.168.18.35", port: 6379 }));
...
app.get("/", (req, res) => {
  res.send("Servidor 3 está funcionando");
});
...
// Super bien bro te quedo espectacular
